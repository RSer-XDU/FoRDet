...
static PyMethodDef __pyx_mdef_13poly_overlaps_1poly_overlaps = {"poly_overlaps", (PyCFunction)__pyx_pw_13poly_overlaps_1poly_overlaps, METH_VARARGS|METH_KEYWORDS, 0};
...
static int __pyx_pymod_exec_poly_overlaps(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init poly_overlaps", 0, __pyx_lineno, __pyx_filename);
    }
