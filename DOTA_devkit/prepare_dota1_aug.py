...
def parse_args():
    ...
    parser.add_argument('--dstpath', default=None,
                        help='prepare data')
...
def prepare(srcpath, dstpath):
    ...
    # if not os.path.exists(os.path.join(dstpath, 'val1024_ms')):
    #     os.makedirs(os.path.join(dstpath, 'val1024_ms'))
    # if not os.path.exists(os.path.join(dstpath, 'trainval1024')):
    #     os.makedirs(os.path.join(dstpath, 'trainval1024'))
    # if not os.path.exists(os.path.join(dstpath, 'train1024_ms')):
    #     os.makedirs(os.path.join(dstpath, 'train1024_ms'))

    # split_train = ImgSplit_multi_process.splitbase(os.path.join(srcpath, 'train'),
    #                    os.path.join(dstpath, 'train1024_ms'),
    #                   gap=200,
    #                   subsize=1024,
    #                   num_process=32
    #                   )
    ...
    #                    os.path.join(dstpath, 'val1024_ms'),
    #                   gap=200,
    #                   subsize=1024,
    #                   num_process=16
    #                   )
    ...
    DOTA2COCOTrain(os.path.join(dstpath, 'val1024_ms'), os.path.join(dstpath, 'val1024_ms', 'DOTA_val1024_ms.json'), wordname_15, difficult='2')
