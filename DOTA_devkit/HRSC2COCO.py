...
def HRSC2COCOTrain(srcpath, destfile, cls_names, difficult='2'):
    imageparent = os.path.join(srcpath, 'images')
    labelparent = os.path.join(srcpath, 'labelTxt')

    data_dict = {}
    info = { 'contributor': 'XXX',
             'data_created': '2019',
...
if __name__ == '__main__':
    ...
    HRSC2COCOTrain(r'/media/xaserver/DATA/zty/FoRDet/HRSC/trainval/',
                   r'/media/xaserver/DATA/zty/FoRDet/HRSC/trainval/HRSC_train.json',
                   L1_names,
                   r'/media/xaserver/DATA/zty/FoRDet/HRSC/trainval.txt')
    HRSC2COCOTest(r'/media/xaserver/DATA/zty/FoRDet/HRSC/test/',
                  r'/media/xaserver/DATA/zty/FoRDet/HRSC/test/HRSC_test.json',
                  L1_names,
                  r'/media/xaserver/DATA/zty/FoRDet/HRSC/test.txt')
