...
from cocoapi.PythonAPI.pycocotools2.draw_cocoeval import COCOeval
...
def _log_detection_eval_metrics(json_dataset, coco_eval):
    ...
    precision = coco_eval.eval['precision'][ind_lo:(ind_hi + 1), :, :, 0, 0] # all 2000 boxes
    ...
    for cls_ind, cls in enumerate(json_dataset.classes):
        ...
        precision = coco_eval.eval['precision'][ind_lo:(ind_hi + 1), :, cls_ind - 1, 0, 0] # all 2000 boxes
