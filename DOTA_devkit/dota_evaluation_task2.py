...
def main():
    ...
    detpath = r'../SSD_obb/HBB/iter_liner_2_fordet_ssd512_hbb_2x/val/Task2_results_nms/{:s}.txt'
    annopath = '/media/xaserver/DATA/zty/FoRDet/DOTA/val_hbb/labelTxt_hbb_v1.0/{:s}.txt' # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imagesetfile = r'/media/xaserver/DATA/zty/FoRDet/DOTA/val_hbb/val.txt'
