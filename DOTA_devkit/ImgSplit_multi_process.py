...
class splitbase():
    def __init__(self,
        ...
        self.labelpath = os.path.join(self.basepath, 'labelsTxt')
        self.outimagepath = os.path.join(self.outpath, 'images')
        self.outlabelpath = os.path.join(self.outpath, 'labelsTxt')
...
if __name__ == '__main__':
    ...
    split_test_single = splitbase(r'/media/xaserver/DATA/zty/FoRDet/1871',
                                  r'/media/xaserver/DATA/zty/FoRDet/1871/split',
                                  gap=200,
                                  subsize=1024,
                                  num_process=16)
    split_test_single.splitdata(1)
