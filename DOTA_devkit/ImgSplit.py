...
class splitbase():
    def __init__(self,
        ...
        self.thresh = thresh
        self.imagepath = os.path.join(self.basepath, 'raw')
...
if __name__ == '__main__':
    ...
    split = splitbase(r'/media/xaserver/DATA1/zty/mmdetection/dataset/foolish',
                       r'/media/xaserver/DATA1/zty/mmdetection/dataset/foolish/split') ## time cost: 4minute 16s
    # split.splitdata(1)
    # split.splitdata(2)
    split.splitdata(0.5)
