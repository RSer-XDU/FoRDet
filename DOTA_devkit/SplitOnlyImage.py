...
if __name__ == '__main__':
    split = splitbase(r'/media/xaserver/DATA1/zty/dataset/SSDD_MSTAR/foolish_200124/orig/images',
                      r'/media/xaserver/DATA1/zty/dataset/SSDD_MSTAR/foolish_200124/split/images',
                      ext='.jpg')
    split.splitdata(1)
