...
def soft_anchor_target(anchor_list,
                  cls_score_list,
                  valid_flag_list,
                  gt_bboxes_list,
                  img_metas,
...
def soft_anchor_target_single(flat_anchors,
                         cls_scores,
                         valid_flags,
                         gt_bboxes,
                         gt_bboxes_ignore,
    ...
    if len(pos_inds) > 0:
        ...
        pos_gt_bboxes = sampling_result.pos_gt_bboxes[:, :4]
        pos_bboxes = sampling_result.pos_bboxes
        pos_overlaps = bbox_overlaps(pos_gt_bboxes, pos_bboxes)
        ...
        bboxe_re_weight = torch.reshape(re_weight, (re_weight.size(0), 1)).repeat(1,4)
