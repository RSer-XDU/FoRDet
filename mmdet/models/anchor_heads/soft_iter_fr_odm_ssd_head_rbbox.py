...
from mmdet.core import (AnchorGenerator, soft_rotation_anchor_target_rbbox, weighted_smoothl1,
...
class SOFTITERFRODMSSDHeadRbbox(AnchorHeadRbbox):
    ...
    def loss(self,
        ...
        # iter_factor = 1
        cls_reg_targets = soft_rotation_anchor_target_rbbox(
            arm_anchors_list,
            arm_cls_scores_list,
            valid_flag_list,
            gt_bboxes,
    ...
    def get_bboxes(self, arm_cls_scores, arm_bbox_preds, cls_scores, bbox_preds, img_metas, cfg,
        ...
        mlvl_rbbox_anchors, mlvl_cls_scores = self.get_arm_bboxes(arm_cls_scores, arm_bbox_preds, img_metas)
