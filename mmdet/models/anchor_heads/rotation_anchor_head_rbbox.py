...
from mmdet.core import (RotationAnchorGenerator, rotation_anchor_target_rbbox, delta2bbox,
...
class RotationAnchorHeadRbbox(nn.Module):
    ...
    def __init__(self,
                 ...
                 anchor_angles=[-np.pi / 2, -np.pi / 3, -np.pi / 4],
        ...
        super(RotationAnchorHeadRbbox, self).__init__()
        ...
        for anchor_base in self.anchor_base_sizes:
            self.anchor_generators.append(
                RotationAnchorGenerator(anchor_base, anchor_scales, anchor_ratios, anchor_angles))
