...
class RefineRetinanetRbbox(BaseDetectorNew):
    ...
    def __init__(self,
        ...
        super(RefineRetinanetRbbox, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(RefineRetinanetRbbox, self).init_weights(pretrained)
    ...
    def forward_train(self,
        ...
        if self.feature_adaption:
            outs = self.rbbox_head(x, arm_outs)
        else:
